...
const Car = () => {
  return (
    <div>
      ...
      <div className="absolute top-[220px] left-[490px] w-[260.1px] h-[329.1px] text-left text-xl-8  font-poppins">
      <Carcard/>
      </div>
      <div className="absolute top-[220px] left-[780px] w-[260.1px] h-[329.1px] text-left text-xl-8  font-poppins">
      <Carcard/>
      </div>
      <div className="absolute top-[220px] left-[1060px] w-[260.1px] h-[329.1px] text-left text-xl-8  font-poppins">
      <Carcard/>
      </div>
