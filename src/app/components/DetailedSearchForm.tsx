...
const DetailedSearchForm = () => {
  return (
    <div className="bg-[#EDEEF0] h-[2800px]">
      ...
      <p className="font-semibold text-black absolute top-[270px] left-[400px] w-[254px] h-[157px] text-left text-sm text-blue font-poppins">
        Mark, model, variant
      </p>
     ...
     <p className="absolute top-[1160px] left-[400px] text-base font-semibold text-black">
     Wheel drive
      </p>
...
<div>
      <p className="absolute top-[1270px] left-[400px] text-base font-semibold text-black">
      Electric vehicles
      </p>
      ...
      <p className="absolute top-[1300px] left-[530px] text-base font-semibold text-black">
        Vehicle type
      </p>
      </div>


<p className="absolute top-[1400px] left-[400px] text-base font-semibold text-black">
Fast charge time
      </p>
<div className='absolute top-[1400px] left-[400px] border-blue-500'>
      ...
      <p className="absolute top-[1500px] left-[400px] text-base font-semibold text-black">
      Power (hp)
      </p>
